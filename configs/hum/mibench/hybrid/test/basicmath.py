...
# create two ranges to represent different memories(STTRAM, SRAM)
system.mem_ranges = [AddrRange('16MB'), AddrRange('16MB','20MB')]
...
system.sram_delay = SimpleMemDelay(read_req = '3.191ns',write_req= '11.151ns')
system.sttram_delay = SimpleMemDelay(
                        read_req = '13.322ns', write_req = '13.322ns')
...
process.output = 'basicmath_small.out'
