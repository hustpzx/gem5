"""
We use this file to test and debug the silc which manages two
...
system.mem_ranges = [AddrRange('512kB'), AddrRange('512kB','4608kB')]
...
#process.cmd = ['tests/test=progs/umc/case2_ary']
