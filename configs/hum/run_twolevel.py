"""
We use this file to test and debug the TwoLevel configuration which consists of
a single-level direct-mapping cache and a simpleMemory.
...
system.mem_ranges = [AddrRange('8MB')]
...
system.cache = TwoLevel(size = '1MB')
